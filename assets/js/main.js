 ...
 * Countdown
 */
$('.countdown-module').each(function() {
	var self = $(this),
...
function consultForm(argument) {
	var _hForm = $('.js-consult-form .js-consult-form-content').outerHeight() / 2;
...
$('.js-consult-form .js-consult-form-content').css('bottom', - _hForm);
...
function work() {
	$('.grid-css').each(function() {
		var workWrapper = $(this),
			workContainer = $('.grid-inner', workWrapper),
...
$('.js-post-effect').each(function() {
	var contentHeight = $(this).find('.post-02-content').height() + 30;

if(windowWidth > 768) {
		var contentHeight = $(this).find('.post-02-content').height() + 50;
	}

$(this).find('.post-02-body').css('transform', 'translateY(' + contentHeight + 'px)');

$(this).hover(function() {
		$(this).find('.post-02-body').css('transform', 'translateY(' + 0 + 'px)');
	}, function() {
		$(this).find('.post-02-body').css('transform', 'translateY(' + contentHeight + 'px)');
	});
});
